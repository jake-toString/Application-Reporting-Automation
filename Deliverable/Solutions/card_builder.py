...
def main(argv):
    ...
    app_name = 'Solutions';                                                   # name of the application
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            app_name + "-FrontPageGraph-" + Helpers.timeDelta_Resolution(today).strftime("%Y-%m-%d") + ".png"
        )
    );
    Helpers.constructPayload(
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "solutions-DCA-Apphealth-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.")
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "solutions-DCA-OpTime-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "solutions-DCA-Availability-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "solutions-DCA-Usage-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");
    ...
    for i in range(0, 10):
            dataContainer.append(DCRumHelpers.Tokenize_3(DCRumAPI.GET_Top_Ten_Slow_Sol(), i));
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "solutions-DCA-Transaction-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");     
