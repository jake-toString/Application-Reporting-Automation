...
def main(argv):
    ...
    app_name = 'Learn';                                                       # name of the application
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "learn-DCA-Apphealth-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.")
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "learn-DCA-OpTime-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "learn-DCA-Availability-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "learn-DCA-Usage-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");
    ...
    for i in range(0, 10):
            dataContainer.append(DCRumHelpers.Tokenize_3(DCRumAPI.GET_Top_Ten_Slow_Ler(), i));
    ...
    Helpers.constructPayload(
        Helpers.imageTag(
            id_, 
            "learn-DCA-Transaction-GraphOnly-" + Helpers.timeDelta_Resolution(datetime.datetime.now()).strftime("%m-%d-%Y") + ".png"
        )
    );
    print("Done.");     
